...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused() {
        require(_paused == false, 'Contract has been paused');
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), 'Given address is the owner of the token');

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == ownerOf(tokenId) || isApprovedForAll(ownerOf(tokenId), msg.sender), 'Not the owner of the token or approve for all is not active');
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId] == address(0), 'tokenid exists already');
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), 'You are not the owner of the token');
